...
import (
	...
	"github.com/bosshentai/fc-lx/chatservice/internal/domain/entity"
	"github.com/bosshentai/fc-lx/chatservice/internal/domain/gateway"
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	for {
		...
		if err != nil {
			return nil, errors.New("error streaming completion: " + err.Error())
		}
